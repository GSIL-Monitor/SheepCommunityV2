...
namespace Aliyun.Green
{
    ...
    /// </summary>
    [JsonObject]
    public class TextScanResponseData
    {
        /// <summary>
        ...
        ///     对应的请求中的content。
        /// </summary>
        [JsonProperty(Order = 5, PropertyName = "content", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        public TextScanResponseDataResult[] Results { get; set; }
    }
}