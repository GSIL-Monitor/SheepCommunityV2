...
namespace ServiceStack.Extensions
{
    ...
    public static class Int64Extensions
    {
        ...
        public static void ThrowIfNotEqual(this long value, string varName, long givenValue, string errorMessage = null)
        {
            if (value != givenValue)
            {
        ...
        /// <param name="errorMessage">抛出异常的错误信息。</param>
        public static void ThrowIfOutOfRange(this long value, string varName, long minValue, long maxValue, string errorMessage = null)
        {
            if (value < minValue)
            {
        ...
        /// <param name="maxValue">指定范围的最大值。</param>
        /// <param name="errorMessage">抛出异常的错误信息。</param>
        public static void ThrowIfOutOfRangeWhenOtherFieldEnabled(this long value, string varName, bool otherFieldEnabled, long minValue, long maxValue, string errorMessage = null)
        {
