...
namespace Sheep.ServiceModel.Paragraphs
{
    ...
    ///     更新一条节注释的请求。
    /// </summary>
    [Route("/books/{BookId}/volumes/{VolumeNumber}/chapters/{ChapterNumber}/paragraphs/{ParagraphNumber}/annotations/{AnnotationNumber}", HttpMethods.Put, Summary = "更新一条节注释")]
    [DataContract]
    public class ParagraphAnnotationUpdate : IReturn<ParagraphAnnotationUpdateResponse>
    {
        /// <summary>
        ///     书籍编号。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class ParagraphAnnotationUpdateResponse : IHasResponseStatus
    {
        /// <summary>
        ///     节注释信息。
        /// </summary>
