...
namespace Sheep.ServiceModel.Chapters
{
    ...
    ///     查询并列举一组章的请求。
    /// </summary>
    [Route("/books/{BookId}/volumes/{VolumeNumber}/chapters/query", HttpMethods.Get, Summary = "查询并列举一组章信息")]
    [DataContract]
    public class ChapterList : IReturn<ChapterListResponse>
    {
        /// <summary>
        ///     书籍编号。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class ChapterListResponse : IHasResponseStatus
    {
        /// <summary>
        ///     章信息列表。
        /// </summary>
