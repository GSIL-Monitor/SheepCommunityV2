...
namespace Sheep.ServiceModel.Chapters
{
    ...
    ///     更新一条章注释的请求。
    /// </summary>
    [Route("/books/{BookId}/volumes/{VolumeNumber}/chapters/{ChapterNumber}/annotations/{AnnotationNumber}", HttpMethods.Put, Summary = "更新一条章注释")]
    [DataContract]
    public class ChapterAnnotationUpdate : IReturn<ChapterAnnotationUpdateResponse>
    {
        /// <summary>
        ///     书籍编号。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class ChapterAnnotationUpdateResponse : IHasResponseStatus
    {
        /// <summary>
        ///     章注释信息。
        /// </summary>
