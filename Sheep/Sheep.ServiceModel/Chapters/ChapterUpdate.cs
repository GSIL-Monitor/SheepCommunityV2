...
namespace Sheep.ServiceModel.Chapters
{
    ...
    ///     更新一章的请求。
    /// </summary>
    [Route("/books/{BookId}/volumes/{VolumeNumber}/chapters/{ChapterNumber}", HttpMethods.Put, Summary = "更新一章")]
    [DataContract]
    public class ChapterUpdate : IReturn<ChapterUpdateResponse>
    {
        /// <summary>
        ///     书籍编号。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class ChapterUpdateResponse : IHasResponseStatus
    {
        /// <summary>
        ///     章信息。
        /// </summary>
