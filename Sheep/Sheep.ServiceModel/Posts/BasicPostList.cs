...
namespace Sheep.ServiceModel.Posts
{
    ...
    /// <summary>
    ///     根据作者查询并列举一组帖子基本信息的请求。
    /// </summary>
    [Route("/posts/basic/query/byauthor", HttpMethods.Get, Summary = "根据作者查询并列举一组帖子基本信息")]
    [DataContract]
    public class BasicPostListByAuthor : IReturn<PostListResponse>
    {
        /// <summary>
        ///     作者的用户编号。
        /// </summary>
    ...
    /// <summary>
    ///     根据已关注的作者列表查询并列举一组帖子基本信息的请求。
    /// </summary>
    [Route("/posts/basic/query/byfollowingowners", HttpMethods.Get, Summary = "根据已关注的作者列表查询并列举一组帖子基本信息")]
    [DataContract]
    public class BasicPostListByFollowingOwners : IReturn<PostListResponse>
    {
        /// <summary>
        ///     分类的标签。
        /// </summary>
