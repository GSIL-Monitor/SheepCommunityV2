...
namespace Sheep.ServiceModel.Posts
{
    ...
    ///     查询并列举一组帖子的请求。
    /// </summary>
    [Route("/posts/query", HttpMethods.Get, Summary = "查询并列举一组帖子信息")]
    [DataContract]
    public class PostList : IReturn<PostListResponse>
    {
        /// <summary>
        ///     过滤标题及概要。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class PostListResponse : IHasResponseStatus
    {
        /// <summary>
        ///     帖子信息列表。
        /// </summary>
        [DataMember(Order = 1)]
        [ApiMember(Description = "帖子信息列表")]
