...
namespace Sheep.ServiceModel.Users
{
    ...
    public class UserList : IReturn<UserListResponse>
    {
        ...
        public long? LockedSince { get; set; }
    ...
    ///     根据编号列表查询并列举一组用户的请求。
    /// </summary>
    [Route("/users/query/byids", HttpMethods.Get, Summary = "根据编号列表查询并列举一组用户")]
    [DataContract]
    public class UserListByIds : IReturn<UserListResponse>
    {
        /// <summary>
        ///     用户编号列表。
        /// </summary>
        ...
        ///     锁定日期在指定的时间之后。
        /// </summary>
        [DataMember(Order = 4, Name = "lockedsince")]
        [ApiMember(Description = "锁定日期在指定的时间之后")]
        public long? LockedSince { get; set; }
