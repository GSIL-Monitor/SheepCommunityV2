...
{
    /// <summary>
    ///     根据上级查询并列举查询并列举一组评论的请求。
    /// </summary>
    [Route("/comments/query/byparent", HttpMethods.Get, Summary = "根据上级查询并列举查询并列举一组评论信息")]
    [DataContract]
    ...
    /// <summary>
    ///     根据用户查询并列举查询并列举一组评论的请求。
    /// </summary>
    [Route("/comments/query/byuser", HttpMethods.Get, Summary = "根据用户查询并列举查询并列举一组评论信息")]
    [DataContract]
