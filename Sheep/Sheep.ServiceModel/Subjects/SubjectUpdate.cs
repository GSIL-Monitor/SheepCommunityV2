...
namespace Sheep.ServiceModel.Subjects
{
    ...
    ///     更新一个主题的请求。
    /// </summary>
    [Route("/books/{BookId}/volumes/{VolumeNumber}/subjects/{SubjectNumber}", HttpMethods.Put, Summary = "更新一个主题")]
    [DataContract]
    public class SubjectUpdate : IReturn<SubjectUpdateResponse>
    {
        /// <summary>
        ///     书籍编号。
        /// </summary>
    ...
    /// </summary>
    [DataContract]
    public class SubjectUpdateResponse : IHasResponseStatus
    {
        /// <summary>
        ///     主题信息。
        /// </summary>
