...
namespace Sheep.Model.Read
{
    ...
    public interface IVolumeRepository
    {
        ...
        /// <returns>卷列表。</returns>
        List<Volume> FindVolumes(string titleFilter, string orderBy, bool? descending, int? skip, int? limit);
        ...
        /// <param name="limit">获取的行数。</param>
        /// <returns>卷列表。</returns>
        Task<List<Volume>> FindVolumesAsync(string titleFilter, string orderBy, bool? descending, int? skip, int? limit);
        ...
        /// <param name="titleFilter">过滤标题及概要的表达式。</param>
        /// <returns>卷数量。</returns>
        int GetVolumesCount(string titleFilter);
        ...
        /// <param name="titleFilter">过滤标题及概要的表达式。</param>
        /// <returns>卷数量。</returns>
        Task<int> GetVolumesCountAsync(string titleFilter);
